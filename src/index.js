...
const PrintVisibilityControls = (props) => {
	...
	return (
		<div
			className="controls-panel-item print-engine-block-control"
			style={{
				padding: '0 1em',
			}}
		>
			<h3
				className="controls-panel-item__header"
				style={{
					display: 'flex',
					flexDirection: 'row',
					alignItems: 'center',
				...
				<ToggleControl
					...
					onChange={() =>
						update({
							...
							hideOnPrint: displayOnPrint ? hideOnPrint : false,
						})
					}
				/>
			</div>
